...
A minimal iOS home-screen web app that converts page numbers between two editions of Iain M. Banks' Player of Games series. Built to solve a specific problem: reading the Folio Society hardback alongside the ePub on a XTEInk e-reader, where page numbers differ significantly between editions.
